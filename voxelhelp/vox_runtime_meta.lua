vox_runtime_meta = { varsTable = { } }

function vox_runtime_meta:new(varsTable)
    local o = { varsTable = { } }
    setmetatable(o, self)
    self.__index = self
...
function vox_runtime_meta:setVar(x, y, z, varname, value)
...
function vox_runtime_meta:getVar(x, y, z, varname)
   if self.varsTable[x] ~= nil then
       if self.varsTable[x][y] ~= nil then
            if self.varsTable[x][y][z] ~= nil then
