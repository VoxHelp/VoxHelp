...
function luamath.sinh(x) -- гипербо-ий синус
    return (2.718281828459045235360287^x-2.718281828459045235360287^(-x))/2
end
...
function luamath.tanh(x)
    ...
    if (t>=0 and t) or -t < 800 then
        return (2.71828182845904523536^t-2.71828182845904523536^(-t))/(2.71828182845904523536^(-t)+2.71828182845904523536^t)
...
function luamath.asin(t)
    if t < -luamath.pi/2 or t > luamath.pi/2 then return luamath.internal.nan end
